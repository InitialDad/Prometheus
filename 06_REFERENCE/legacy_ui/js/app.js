...
import { PlanRoomPanel } from './planroom.js';
...
document.querySelectorAll('.tab').forEach(t => {
  t.onclick = () => {
    ...
    if (tab in overlayIds) {
      ...
      if (tab === 'planroom'&& !planRoomPanel) planRoomPanel = new PlanRoomPanel(state.games);
