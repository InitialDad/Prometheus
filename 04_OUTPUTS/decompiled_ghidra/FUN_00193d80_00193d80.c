...
undefined8
FUN_00193d80(undefined4 *param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
            undefined8 param_5)

{
  ...
  if (lVar2 == 0) {
    ...
    if (((*(uint *)((int)lVar2 + 0x3c8) & 0x40000) == 0) &&
       (((((puVar1 = *(undefined **)((int)lVar2 + 0x3c4), puVar1 == (undefined *)0x6d ||
