...
undefined4 FUN_00116288(undefined4 param_1,long param_2,undefined8 *param_3,undefined4 *param_4)
  ...
  if (-1 < lVar3) {
    ...
    if (lVar3 == 0) {
      ...
      if (param_3 == (undefined8 *)0x0) {
        ...
        uRam00228b44 = (undefined4)param_2;
      }
      else {
      ...
      lVar3 = FUN_00111e00(0x228d40,7,0,0x228b40,0x200,0x228b40,8,0);
      uVar1 = uRam00228b40;
      if (lVar3 < 0) {
        uVar1 = 0xfffeffff;
      }
