...
undefined8
FUN_00194190(int *param_1,undefined8 param_2,undefined8 param_3,int *param_4,undefined8 param_5)

{
  ...
  if (lVar2 != 0) {
    if (iStack_4 != 0) {
      FUN_001efd30(uRam008dcb78,lVar2);
      iVar1 = *param_4;
      goto LAB_00194270;
    }
    FUN_001efb20(uRam008dcb78,lVar2);
  }
  iVar1 = *param_4;
LAB_00194270:
  *param_1 = iVar1;
