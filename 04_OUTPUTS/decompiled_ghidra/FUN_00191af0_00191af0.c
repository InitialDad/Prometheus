...
undefined8
FUN_00191af0(int *param_1,undefined8 param_2,undefined8 param_3,int *param_4,undefined8 param_5)

{
  ...
  FUN_0011ede0(0x22be40,0,uVar1);
  if (iStack_4 == 1) {
    FUN_0011ed60(0x22be40);
  }
  FUN_0011da70(uRam008dcb34,0x22be40);
  *param_1 = *param_4;
  if (*param_1 != 0) {
    param_1[1] = param_4[1];
