...

{
  ...
  FUN_00105cf0(auStack_70,*(int *)(param_1 + 0x10) + 0x10);
  FUN_00105ce0(auStack_80,auStack_40);
  FUN_00105ce0(auStack_40,0x204b80);
  fStack_30 = (float)_DAT_00203860;
  uStack_2c = (undefined4)((ulong)_DAT_00203860 >> 0x20);
  fStack_28 = DAT_00203868;
  uStack_24 = DAT_0020386c;
  FUN_00105a30(&fStack_30,auStack_70);
  iVar7 = 5;
  do {
    fStack_20 = (float)uRam008dc470;
    uStack_1c = (undefined4)((ulong)uRam008dc470 >> 0x20);
    fStack_18 = (float)uRam008dc478;
    uStack_14 = uRam008dc47c;
    iVar2 = FUN_001d2930();
    ...
    iVar2 = FUN_001d2930();
    fStack_20 = fStack_20 + fStack_30 * (float)(iVar2 % 200 + -100) * 0.01;
    iVar2 = FUN_001d2930();
    fStack_18 = fStack_18 + fStack_28 * (float)(iVar2 % 200 + -100) * 0.01;
    FUN_00105c98(0x3e4ccccd,&fStack_20,&fStack_20);
    FUN_00105c50(&fStack_20,&fStack_20,auStack_80);
    iVar2 = FUN_001d2930();
