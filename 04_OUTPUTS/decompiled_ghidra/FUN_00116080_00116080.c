...
undefined4 FUN_00116080(undefined4 param_1,long param_2,undefined8 *param_3,undefined4 *param_4)

{
  ...
  if (-1 < lVar3) {
    ...
    if (lVar3 == 0) {
      ...
      lVar3 = FUN_00111e00(0x228d40,6,0,0x228b40,0x200,0x228b40,8,0);
      uVar1 = uRam00228b40;
      if (lVar3 < 0) {
        uVar1 = 0xfffeffff;
      }
