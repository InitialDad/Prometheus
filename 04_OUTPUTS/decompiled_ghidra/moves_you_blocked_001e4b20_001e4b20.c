...
void moves_you_blocked_001e4b20(undefined8 param_1)

{
  ...
  FUN_001e5460();
  FUN_001e48d0(param_1,9,0x6ed0,0x79f0,1,0,0,0);
  FUN_001e48d0(param_1,8,30000,0x79f0,1,2,0,0);
  iVar8 = (int)param_1;
  iVar6 = 0;
  iVar1 = 0;
  for (lVar3 = 0; lVar3 < *(short *)(iVar8 + 0x60); lVar3 = (long)((int)lVar3 + 1)) {
    if ((*(byte *)(*(int *)(iVar8 + 0x6c) + iVar1 + 6) & 4) != 0) {
      iVar6 = iVar6 + 1;
    }
    iVar1 = iVar1 + 0x40;
  }
  ...
  if (6 < iVar6) {
    FUN_001e48d0(param_1,7,0x9100,
                 ((*(short *)(iVar8 + 0x6a) * 0x95) / (iVar6 + -6) + 0x1c) * 0x10 + 0x7900,1,0,0,0);
  }
  ...
  FUN_00148fe0(0x3f428f5c,*(undefined4 *)(iRam008dcb2c + 0x248),PTR_DAT_002113dc,uVar2,0x7a00,2,0x14
               ,0);
  for (lVar3 = (long)*(short *)(iVar8 + 0x6a); lVar3 < *(short *)(iVar8 + 0x6a) + 6;
      lVar3 = (long)((int)lVar3 + 1)) {
    lVar4 = 0;
    if (*(short *)(iVar8 + 0x60) <= lVar3) break;
    iVar1 = 0;
    for (lVar7 = 0; lVar7 < *(short *)(iVar8 + 0x60); lVar7 = (long)((int)lVar7 + 1)) {
      if ((*(byte *)(*(int *)(iVar8 + 0x6c) + iVar1 + 6) & 4) != 0) {
        if (lVar4 == lVar3) goto LAB_001e4f08;
...
LAB_001e4f08:
    if (-1 < lVar7) {
      iVar1 = ((int)lVar3 - (int)*(short *)(iVar8 + 0x6a)) * 0x1c;
      ...
      FUN_00148a90(*(undefined4 *)(iRam008dcb2c + 0x248),
                   *(int *)(iVar8 + 0x6c) + (int)lVar7 * 0x40 + 7,0x6ec0,
