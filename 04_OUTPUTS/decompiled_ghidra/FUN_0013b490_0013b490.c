...
void FUN_0013b490(short *param_1)

{
  ...
  *param_1 = sVar3 + -1;
  ...
  if (fVar15 < 0.6) {
    *(float *)(param_1 + 0x1a) = fVar15 + 0.1;
  }
  else {
    *(float *)(param_1 + 0x1a) = fVar15 + 0.01;
  }
  ...
  if (bVar12) {
    ...
    FUN_00147810((ulong)uVar7 << 0x1e |
                 ...
                 iVar11 + 0x6e,uVar10 & 0x808080 | (int)(uVar13 * (int)sVar3) / (int)sVar4 << 0x18,
                 auStack_50);
  }
  return;
}
