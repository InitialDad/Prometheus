...
undefined8
FUN_00191420(int *param_1,undefined8 param_2,undefined8 param_3,int *param_4,undefined8 param_5)

{
  ...
  uVar2 = FUN_001349e0(0x8dcb00,uStack_4);
  FUN_0011f2c0(0x22bdf0,uVar1,uVar2);
  FUN_0011da70(uRam008dcb34,0x22bdf0);
  *param_1 = *param_4;
  if (*param_1 != 0) {
    param_1[1] = param_4[1];
