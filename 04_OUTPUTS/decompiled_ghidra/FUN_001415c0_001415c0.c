...
void FUN_001415c0(short *param_1)

{
  ...
  *(float *)(param_1 + 0x12) = *(float *)(param_1 + 0x12) - 0.0054444447;
  fVar14 = *(float *)(param_1 + 0x18) + 0.002;
  *(float *)(param_1 + 0x18) = fVar14;
  ...
  if (bVar12) {
    ...
    FUN_00147810((ulong)uVar8 << 0x1e |
                 ...
                 iVar11 + 0x78,uVar10 | ((int)sVar3 << 7) / (int)sVar4 << 0x18,auStack_50);
  }
  sVar3 = *param_1;
  *param_1 = sVar3 + -1;
  if (sVar3 == 0) {
