...
undefined8
FUN_00197fc0(int *param_1,undefined8 param_2,undefined8 param_3,int *param_4,undefined8 param_5)

{
  ...
  FUN_00185d30(*(undefined4 *)(iRam008dcb58 + 0x67c),uStack_8);
  lVar1 = FUN_001349e0(0x8dcb00,uStack_4);
  if (lVar1 != 0) {
    FUN_0012ae90(lVar1,8,0,0);
    *(undefined4 *)((int)lVar1 + 0x510) = 8;
    *(undefined4 *)((int)lVar1 + 0xcb0) = 0;
  }
  *param_1 = *param_4;
  if (*param_1 != 0) {
    param_1[1] = param_4[1];
