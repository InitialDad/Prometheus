...
undefined8
FUN_001a23b0(int *param_1,undefined8 param_2,undefined8 param_3,int *param_4,undefined8 param_5)
      ...
      if (piVar3 != (int *)0x0) {
        ...
        *puVar6 = 0;
        ...
        if (iVar1 != -1) {
          ...
          FUN_0014ffa0(auStack_50,auStack_60,0x21b188);
          oneself_d_0017df90(iRam008dcb58,auStack_50);
