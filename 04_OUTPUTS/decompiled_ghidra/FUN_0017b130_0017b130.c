...
void FUN_0017b130(undefined8 param_1,int param_2)

{
  ...
  if (iRam008dcb00 != 3) {
    FUN_00185b70(*(undefined4 *)(iRam008dcb58 + 0x67c),
                 *(undefined4 *)(*(int *)(param_2 + 0x388) + 0x54));
    if ((*(char *)(param_2 + 0xcd5) == '\0') || (param_2 == iRam008dcb20)) {
      FUN_00120130(param_2);
    }
    else {
      FUN_001d3440(auStack_d0,0x219660,*(undefined4 *)(*(int *)(param_2 + 0x388) + 0x54),
      ...
      *(undefined4 *)(iVar1 + 0x3c) = 1;
      ...
      puStack_14 = &DAT_00223cb0;
      if ((*(ulong *)(param_2 + 0xca0) & 8) != 0) {
        FUN_00120130(param_2);
        *(ulong *)(param_2 + 0xca0) = *(ulong *)(param_2 + 0xca0) | 8;
      }
      *(undefined1 *)(param_2 + 0xcd5) = 1;
    }
    FUN_0012f760(param_2,*(undefined4 *)(param_2 + 0x56c),*(undefined2 *)(param_2 + 0x570));
    FUN_0014abc0(0x8dcb00,param_2);
