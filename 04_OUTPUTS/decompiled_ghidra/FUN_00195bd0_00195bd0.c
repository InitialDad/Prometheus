...
undefined8
FUN_00195bd0(int *param_1,undefined8 param_2,undefined8 param_3,int *param_4,undefined8 param_5)

{
  ...
  if (lVar2 != 0) {
    iVar1 = (int)lVar2;
    if (iStack_4 == 0) {
      *(ushort *)(iVar1 + 0x3c2) = *(ushort *)(iVar1 + 0x3c2) & 0xfffb;
    }
    else {
      *(ushort *)(iVar1 + 0x3c2) = *(ushort *)(iVar1 + 0x3c2) | 4;
    }
  }
  *param_1 = *param_4;
  if (*param_1 != 0) {
