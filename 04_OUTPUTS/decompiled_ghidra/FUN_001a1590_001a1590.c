...
undefined8
FUN_001a1590(int *param_1,undefined8 param_2,undefined8 param_3,int *param_4,undefined8 param_5)

{
  ...
  *(uint *)(iRam008dcb58 + 0x160) = uStack_c + uStack_4 * 0x10000 + -0x80000000 + uStack_8 * 0x100;
