...
void FUN_001410a0(short *param_1)

{
  ...
  fVar14 = *(float *)(param_1 + 0x18) + 0.01;
  *(float *)(param_1 + 0x18) = fVar14;
  ...
  if (bVar12) {
    uVar9 = *(uint *)(param_1 + 0x1a);
    uVar11 = DAT_002246d8 * *param_1;
    ...
    if (iRam002248fc != 1) {
      FUN_0013a040(uRam008dcb2c,0x42);
      iRam002248fc = 1;
    }
    FUN_00147810((ulong)uVar8 << 0x1e |
                 (ulong)uVar6 << 0x1a | (ulong)bVar1 << 0x14 | (ulong)uVar5 | (ulong)uVar4 << 0xe |
                 0x400000000 | (long)(int)((uint)uVar7 + (uint)bVar2) << 0x25 | 0x2000000000000000,
                 iVar10 + 0x1e,uVar9 | uVar11 / 0x1e << 0x18,auStack_50);
  }
  sVar3 = *param_1;
  *param_1 = sVar3 + -1;
  if (sVar3 == 0) {
