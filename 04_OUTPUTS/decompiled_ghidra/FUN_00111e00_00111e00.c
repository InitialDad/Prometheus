...
undefined4
FUN_00111e00(int *param_1,undefined4 param_2,ulong param_3,long param_4,long param_5,long param_6,
  ...
  *(int *)(iVar4 + 0x34) = iVar1;
  if ((param_3 & 2) == 0) {
    if (param_4 == param_6) {
      ...
      FUN_00111510(param_4,param_7);
    }
    else {
      if (0 < param_5) {
        FUN_00111510(param_4,param_5);
      }
      if (0 < param_7) {
        FUN_00111510(param_6,param_7);
      }
    }
  }
  if ((param_3 & 1) == 0) {
    ...
    *(undefined4 *)(iVar4 + 0x30) = 1;
    lVar3 = FUN_00111368(0xffffffff8000000a,lVar2,0x40,param_4,param_1[5],param_5);
    if (lVar3 != 0) {
      WaitSema(param_1[2]);
