...
ulong FUN_00130e60(undefined8 param_1,long param_2,undefined8 param_3)
      ...
      if ((puVar2 == &DAT_10000036) || (puVar2 == (undefined *)0x10010035)) {
        ...
        *(undefined4 *)(iVar7 + 0x518) = 0x32;
        ...
        uVar5 = 0;
              ...
              ((*(uint *)(iVar7 + 0x3c8) & 0x20000) != 0)) {
        uVar5 = FUN_001311e0(param_1,param_2,param_3);
      }
      else {
        if (param_2 != 0) {
          uStack_60 = *puVar8;
        ...
        if ((*(uint *)(iVar7 + 0x3c8) & 0x10000) == 0) {
          if ((*(int *)(iVar7 + 0x544) == 0) || (cVar3 = FUN_0018c7b0(), cVar3 != '\x02')) {
            lVar6 = FUN_00132280(param_1,*(undefined2 *)(iVar7 + 0x520),0x10010005,0);
            if (lVar6 != 0) {
              return 1;
            }
          }
