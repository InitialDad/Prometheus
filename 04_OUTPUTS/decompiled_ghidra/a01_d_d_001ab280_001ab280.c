...
void a01_d_d_001ab280(long param_1,long param_2,int param_3,int param_4)

{
  ...
  if (param_2 == 0) {
    FUN_001d3440(auStack_230,0x21b5e8,param_1,0);
  ...
  if (param_1 == 0) {
    FUN_001d3440(auStack_1b0,0x21b5e8,0,param_2);
    ...
    while( true ) {
      ...
      if (*piVar1 != param_4) {
        ...
        if ((*(ulong *)(*piVar1 + 0xca0) & 8) != 0) {
          piVar1 = (int *)(**(code **)(puStack_24 + 0xc))();
          FUN_0017c230(uRam008dcb58,auStack_1b0,*(undefined4 *)(*(int *)(*piVar1 + 0x388) + 0x54));
        }
      }
  ...
  if ((*(ulong *)(param_4 + 0xca0) & 8) != 0) {
    FUN_001d3440(auStack_130,0x21b5f8,param_1);
    FUN_0017c230(uRam008dcb58,auStack_130,param_2);
  }
  if ((*(ulong *)(iRam008dcb20 + 0xca0) & 8) != 0) {
    FUN_001d3440(auStack_b0,0x21b5e8,param_1,param_2);
