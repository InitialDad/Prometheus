...
void FUN_00140450(short *param_1)

{
  ...
  if (bVar12) {
    ...
    FUN_00147810((ulong)uVar7 << 0x1e |
                 ...
                 iVar10 + 0x6e,uVar9 & 0xffffff | iVar11 / (int)sVar3 << 0x18,auStack_50);
  }
  sVar3 = *param_1;
  *param_1 = sVar3 + -1;
  if (sVar3 == 0) {
