...
void moves_you_blocked_001e5020(undefined8 param_1)

{
  ...
  FUN_001e5460();
  FUN_001e48d0(param_1,8,0x6ed0,0x79f0,1,0,0,0);
  FUN_001e48d0(param_1,9,30000,0x79f0,1,2,0,0);
  iVar7 = (int)param_1;
  iVar6 = 0;
  iVar3 = 0;
  for (lVar4 = 0; lVar4 < *(short *)(iVar7 + 0x60); lVar4 = (long)((int)lVar4 + 1)) {
    if ((*(byte *)(*(int *)(iVar7 + 0x6c) + iVar3 + 6) & 3) != 0) {
      iVar6 = iVar6 + 1;
    }
    iVar3 = iVar3 + 0x40;
  }
  if (6 < iVar6) {
    FUN_001e48d0(param_1,7,0x9100,
                 ((*(short *)(iVar7 + 0x66) * 0x95) / (iVar6 + -6) + 0x1c) * 0x10 + 0x7900,1,0,0,0);
  }
  ...
  FUN_00148fe0(0x3f59999a,*(undefined4 *)(iRam008dcb2c + 0x248),PTR_s_Moves_You_Blocked_0021141c,
               0x7690,0x79f0,2,0,0);
  uStack_50 = 6;
  lVar4 = (long)*(short *)(iVar7 + 0x66);
  do {
    sVar2 = *(short *)(iVar7 + 0x66);
    if (sVar2 + 6 <= lVar4) {
    ...
    lVar5 = 0;
    iVar6 = 0;
    for (lVar8 = 0; lVar8 < *(short *)(iVar7 + 0x60); lVar8 = (long)((int)lVar8 + 1)) {
      bVar1 = *(byte *)(*(int *)(iVar7 + 0x6c) + iVar6 + 6);
      if ((bVar1 & 1) == 0) {
        if ((bVar1 & 2) != 0) {
          if (lVar5 == lVar4) {
            lVar8 = -1;
        ...
        if (lVar5 == lVar4) goto LAB_001e5270;
        lVar5 = (long)((int)lVar5 + 1);
      }
      iVar6 = iVar6 + 0x40;
    }
...
LAB_001e5270:
    ...
    if (lVar8 < 0) {
      if (lVar8 == -1) {
        ...
        FUN_00148a90(*(undefined4 *)(iRam008dcb2c + 0x248),PTR_DAT_00211450,0x6e70,
      ...
      FUN_00148a90(*(undefined4 *)(iRam008dcb2c + 0x248),
                   *(int *)(iVar7 + 0x6c) + (int)lVar8 * 0x40 + 7,0x6ec0,
