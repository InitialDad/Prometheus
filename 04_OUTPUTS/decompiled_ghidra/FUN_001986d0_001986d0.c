...
undefined8
FUN_001986d0(int *param_1,undefined8 param_2,undefined8 param_3,int *param_4,undefined8 param_5)

{
  ...
  if (lVar1 == 0) {
    ...
    lVar2 = FUN_00155960(*(undefined4 *)(iVar4 + 0x39c));
    if (lVar2 != 0) {
      FUN_00124080(lVar1);
    }
    *(undefined4 *)(iVar4 + 0x95c) = 0;
    ...
    uStack_28 = uStack_58;
    uStack_24 = uStack_54;
    uVar3 = FUN_00185e30(*(undefined4 *)(iRam008dcb58 + 0x67c),&pcStack_50);
  ...
  lVar1 = FUN_00166cd0(param_3,uVar3);
  *param_1 = (int)lVar1;
  if (lVar1 != 0) {
