...
void FUN_00137d60(float param_1,float param_2,float param_3,undefined4 param_4,undefined4 param_5,
...

{
  ...
  *(undefined4 *)(param_9 + 0x27c) = 0x3f800000;
  ...
  fVar2 = (param_8 * DAT_002149d0) / param_1;
  fVar4 = (param_8 * DAT_002149d4) / param_1;
  FUN_00105d58(param_9 + 0x290);
  fVar3 = param_8 * 2.0;
  *(float *)(param_9 + 0x290) = fVar3 / (fVar2 + fVar2);
  *(float *)(param_9 + 0x2a4) = fVar3 / (fVar4 + fVar4);
  fVar2 = (in_stack_00000000 + param_8) / (in_stack_00000000 - param_8);
  fVar4 = (fVar1 * -2.0) / (in_stack_00000000 - param_8);
  *(float *)(param_9 + 0x2b8) = fVar2;
  *(float *)(param_9 + 0x2c8) = fVar4;
  *(undefined4 *)(param_9 + 700) = 0x3f800000;
  *(undefined4 *)(param_9 + 0x2cc) = 0;
  fVar1 = (param_8 * DAT_002149e0) / param_1;
  param_1 = (param_8 * DAT_002149e4) / param_1;
  FUN_00105d58(param_9 + 0x2d0);
  *(float *)(param_9 + 0x2d0) = fVar3 / (fVar1 + fVar1);
  *(float *)(param_9 + 0x2e4) = fVar3 / (param_1 + param_1);
  *(float *)(param_9 + 0x2f8) = fVar2;
  *(float *)(param_9 + 0x308) = fVar4;
  *(undefined4 *)(param_9 + 0x2fc) = 0x3f800000;
  *(undefined4 *)(param_9 + 0x30c) = 0;
  FUN_00105d58(afStack_40);
  fStack_8 = -0.8;
  FUN_00105a60(param_9 + 0x2d0,param_9 + 0x2d0,afStack_40);
  return;
}
