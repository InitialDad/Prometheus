...
undefined8
FUN_001a1ac0(int *param_1,undefined8 param_2,undefined8 param_3,int *param_4,undefined8 param_5)

{
  ...
  if (iStack_c == 2) {
    ...
    if (iStack_48 != iStack_18) {
      ...
      FUN_00166830(iVar1 + 4,auStack_60);
    }
    puStack_44 = &DAT_00223cb0;
  }
  else if (iStack_c == 1) {
    FUN_00166830(iRam008dcb58 + 0x608,auStack_60);
  }
  else {
    if (iStack_c != 0) {
      iVar1 = *param_4;
    ...
    FUN_00166830(iRam008dcb58 + 0x5c8,auStack_60);
  }
  iVar1 = *param_4;
LAB_001a1d1c:
  *param_1 = iVar1;
