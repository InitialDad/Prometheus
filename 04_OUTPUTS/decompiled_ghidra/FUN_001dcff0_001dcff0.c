...
undefined8
FUN_001dcff0(int param_1,int param_2,short param_3,short param_4,undefined4 param_5,ulong param_6,
...

{
  ...
  psVar1 = (short *)(*(int *)(param_1 + 0x9c) + param_2 * 10);
  iVar2 = *(int *)(param_1 + 0xa0) + (uint)*(byte *)((int)psVar1 + 9) * 0x30;
  FUN_001d16a0(auStack_50,0,0x50);
  auStack_50[0] =
