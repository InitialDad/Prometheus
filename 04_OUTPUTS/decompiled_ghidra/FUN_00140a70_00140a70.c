...
void FUN_00140a70(short *param_1)

{
  ...
  fVar13 = *(float *)(param_1 + 0x1a);
  if (fVar13 < 2.0) {
    *(float *)(param_1 + 0x1a) = fVar13 + 0.06;
  }
  else {
    *(float *)(param_1 + 0x1a) = fVar13 + 0.01;
  }
  uVar14 = *(undefined4 *)(param_1 + 0x1a);
  ...
  FUN_00105c98(uVar14,auStack_30,auStack_30);
  ...
  if (bVar11) {
    sVar3 = *param_1;
    sVar4 = param_1[0x1c];
    uVar5 = *(ushort *)(iGpffff8808 + 0x20032);
    bVar1 = *(byte *)(iGpffff8808 + 0x2002e);
    iVar10 = *(int *)(iGpffff8808 + 0x20028);
    uVar6 = *(ushort *)(iGpffff8808 + 0x20034);
    uVar7 = *(ushort *)(iGpffff8808 + 0x20030);
    uVar8 = *(ushort *)(iGpffff8808 + 0x20036);
    uVar9 = *(ushort *)(iGpffff8808 + 0x2004a);
    ...
    FUN_00147810((ulong)uVar8 << 0x1e |
                 ...
                 iVar10 + 0x6e,((int)sVar3 << 7) / (int)sVar4 << 0x18 | 0x606060,auStack_50);
  }
  sVar3 = *param_1;
  *param_1 = sVar3 + -1;
  if (sVar3 == 0) {
