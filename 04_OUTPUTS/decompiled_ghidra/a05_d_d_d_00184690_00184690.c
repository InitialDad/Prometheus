...
void a05_d_d_d_00184690(int param_1)
  ...
  if ((*(ulong *)(param_1 + 0xc98) & 0x80) != 0) {
    ...
    while( true ) {
      ...
      if ((((*(ushort *)(iVar2 + 0x3c2) & 1) != 0) &&
         ...
         (iVar3 = *(int *)(*(int *)(iVar2 + 0x388) + 0x54), (*(ulong *)(iVar2 + 0xca0) & 0x40) != 0)
         ) {
        iVar5 = 0;
        iVar6 = 0;
        do {
        ...
        FUN_001d3440(auStack_a0,0x219840,iVar3,iVar1,uVar7,iVar8);
