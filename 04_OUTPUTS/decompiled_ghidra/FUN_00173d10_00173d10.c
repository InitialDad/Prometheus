...
long FUN_00173d10(long param_1,short param_2)

{
  ...
  if (param_1 != 0) {
    piVar3 = (int *)param_1;
    piVar3[4] = (int)&DAT_00223a90;
    if (piVar3 != (int *)0xffffffdc) {
      if (piVar3 != (int *)0xffffffcc) {
        FUN_00173e20();
      }
      piVar2 = piVar3 + 9;
      if ((piVar2 != (int *)0x0) && (piVar3[0xc] = (int)&DAT_002239c8, piVar2 != (int *)0x0)) {
        piVar3[0xb] = (int)&DAT_002239b8;
