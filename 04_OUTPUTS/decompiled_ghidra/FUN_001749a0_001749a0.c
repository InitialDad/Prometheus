...
long FUN_001749a0(long param_1,short param_2)

{
  ...
  if (param_1 != 0) {
    piVar3 = (int *)param_1;
    piVar3[4] = (int)&DAT_00223b20;
    if (((piVar3 != (int *)0xffffffdc) &&
        (piVar3[0xc] = (int)&DAT_002239c8, piVar3 != (int *)0xffffffdc)) &&
       (piVar3[0xb] = (int)&DAT_002239b8, piVar3 != (int *)0xffffffdc)) {
      FUN_00150160();
    }
    if (param_1 != 0) {
      piVar2 = piVar3 + 5;
