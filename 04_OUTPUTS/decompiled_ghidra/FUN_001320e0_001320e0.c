...
undefined8 FUN_001320e0(undefined8 param_1,undefined8 param_2,undefined *param_3,undefined8 param_4)

{
  ...
  if (sVar3 < 0) {
    ...
    *(undefined **)(iVar7 + 0x3c4) = param_3;
    FUN_00155f50(*(undefined4 *)(iVar7 + 0x39c),**(undefined4 **)(iVar7 + 0x38c),
