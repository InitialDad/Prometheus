...
undefined4 FUN_001d9b70(undefined8 param_1,long param_2)

{
  ...
  uVar5 = uVar5 | uVar6;
  moves_you_blocked_001d7800(param_1);
  if (param_2 == 0) {
    iVar13 = (int)param_1;
    ...
    if ((uVar4 & 0x800) == 0) {
      uVar7 = uVar12;
      if ((uVar5 & (DAT_00218788 | 8)) == 0) {
        if ((uVar5 & (DAT_00218780 | 2)) == 0) {
          if ((uVar4 & DAT_002187a8) == 0) {
            if ((uVar4 & DAT_00218790) != 0) {
              FUN_0019cb60(0,0xff,0);
              uVar7 = 5;
              *(undefined1 *)(iVar13 + 0x10) = 2;
            }
          }
          else {
          ...
          *(char *)(iVar13 + 0x11) = *(char *)(iVar13 + 0x11) + '\x01';
          if ('\x02' < *(char *)(iVar13 + 0x11)) {
            ...
            if (iVar10 != 0) {
              do {
                if (0 < iVar9) {
                  if (*(char *)(iVar13 + 6) < '\x01') {
                    *(short *)(iVar13 + 10) = *(short *)(iVar13 + 10) + -1;
                  }
                  else {
                    *(char *)(iVar13 + 6) = *(char *)(iVar13 + 6) + -1;
                  }
                }
                if (*(short *)(iVar13 + 10) < 0) {
                  *(undefined2 *)(iVar13 + 10) = 0;
                }
                iVar11 = iVar11 + 1;
              } while (iVar11 < iVar10);
            }
            if ((*(char *)(iVar13 + 6) != cVar1) || (*(short *)(iVar13 + 10) != sVar3)) {
          ...
          if (iVar10 != 0) {
            do {
              if (-1 < iVar9) {
                cVar2 = *(char *)(iVar13 + 6);
                if (cVar2 < '\x05') {
                  if ((int)*(short *)(iVar13 + 10) + (int)cVar2 < iVar9) {
                    *(char *)(iVar13 + 6) = cVar2 + '\x01';
                  }
                }
                else if ((int)*(short *)(iVar13 + 10) + (int)cVar2 < iVar9) {
                  *(short *)(iVar13 + 10) = *(short *)(iVar13 + 10) + 1;
                }
              }
              iVar11 = iVar11 + 1;
